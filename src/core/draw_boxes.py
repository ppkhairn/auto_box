...
with open(output_data_dir / "cat_detections.json") as f:
...
for img_result in results:
    ...
    for det in img_result.detections:
        ...
        # Scale normalized [0-1000] coordinates to actual pixels
        ...
        draw.text((left, max(top-10, 0)), f"{det.label} {det.confidence:.2f}", fill="red")
